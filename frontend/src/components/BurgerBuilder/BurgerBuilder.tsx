...
import { useBurgerBuilder } from '../../context/useBurgerBuilder';
...
const SAMPLE_INGREDIENTS = [
  ...
  { id: 4, name: 'Chicken Patty', category: 'patties' as const, price: 3, imageUrl: '' },
  ...
  { id: 9, name: 'Cheese', category: 'toppings' as const, price: 1, imageUrl: '' },
  ...
  useEffect(() => {
    const loadIngredients = async () => {
      try {
        ...
        console.warn('Failed to load ingredients from API, falling back to sample data.', error);
